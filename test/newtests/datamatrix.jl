module TestDataMatrixs
    ...
    # Base.setindex!(dm::DataMatrix, val::Null, i::SingleIndex, j::SingleIndex)
    dm = @data([1 2; null 4])
    dm[1, 1] = null
    ...
    # Base.setindex!(dm::DataMatrix, val::Null, row_inds::MultiIndex, j::SingleIndex)
    dm = @data([1 2; null 4])
    dm[[1, 2], 1] = 3
    ...
    # Base.setindex!(dm::DataMatrix, val::Null, i::SingleIndex, col_inds::MultiIndex)
    dm = @data([1 2; null 4])
    dm[[1, 2], 1] = null
    ...
    # Base.setindex!(dm::DataMatrix, val::Null, row_inds::MultiIndex, col_inds::MultiIndex)
    dm = @data([1 2; null 4])
    dm[[1, 2], [1, 2]] = null
